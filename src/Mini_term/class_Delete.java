...
public class class_Delete implements ActionListener {
	JFrame frame;
	...
	public class_Delete(JFrame aFrame) {
		this.superFrame = aFrame;
		frame = new JFrame("设备类别删除");
		frame.add(pic_panel);
		pic_panel.setLayout(new GridLayout(3,1));
		
		label = new JLabel("请输入删除设备类别的设备类别编号",JLabel.CENTER);
